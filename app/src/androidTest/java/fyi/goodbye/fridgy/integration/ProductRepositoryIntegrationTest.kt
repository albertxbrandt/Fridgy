...
class ProductRepositoryIntegrationTest {
    ...
    @Test
    fun getProductInfo_returnsNullForNonexistent() =
        runTest {
    ...
    @Test
    fun getProductInfo_returnsExistingProduct() =
        runTest {
    ...
    @Test
    fun getProductInfoFresh_returnsLatestProduct() =
        runTest {
    ...
    @Test
    fun saveProductInfo_successfullySavesProduct() =
        runTest {
    ...
    @Test
    fun saveProductInfo_updatesExistingProduct() =
        runTest {
    ...
    @Test
    fun searchProductsByName_findsMatchingProducts() =
        runTest {
            ...
            assertTrue(
                "Should contain Pepsi Cola",
                results.any { it.name == "Pepsi Cola" }
            )
        }

    @Test
    fun searchProductsByName_returnsEmptyForBlankQuery() =
        runTest {
    ...
    @Test
    fun productCaching_reducesDatabaseReads() =
        runTest {
    ...
    @Test
    fun getProductInfoFresh_bypassesCache() =
        runTest {
