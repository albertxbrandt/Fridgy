...
class NotificationRepositoryIntegrationTest {
    ...
    @Test
    fun getNotificationsFlow_returnsUserNotifications() =
        runTest {
    ...
    @Test
    fun getUnreadCountFlow_returnsCorrectCount() =
        runTest {
    ...
    @Test
    fun markAsRead_successfullyMarksNotification() =
        runTest {
    ...
    @Test
    fun markAllAsRead_successfullyMarksAllNotifications() =
        runTest {
    ...
    @Test
    fun deleteNotification_successfullyDeletesNotification() =
        runTest {
            // Create notification
            val notificationId = firestore.collection("notifications").document().id
            testNotifications.add(notificationId)
    ...
    @Test
    fun refreshFcmToken_successfullySavesToken() =
        runTest {
            // Refresh FCM token
