...
class HouseholdRepositoryIntegrationTest {
    ...
    @Test
    fun createHousehold_successfullyCreatesHousehold() =
        runTest {
    ...
    @Test
    fun getHouseholdsForCurrentUser_returnsUserHouseholds() =
        runTest {
            ...
            assertTrue(
                "Should contain household 1",
                households.any { it.id == household1.id }
            )
            assertTrue(
                "Should contain household 2",
                households.any { it.id == household2.id }
            )
        }

    @Test
    fun getHouseholdById_returnsCorrectHousehold() =
        runTest {
    ...
    @Test
    fun getHouseholdById_returnsNullForNonexistent() =
        runTest {
    ...
    @Test
    fun updateHouseholdName_successfullyUpdatesName() =
        runTest {
    ...
    @Test
    fun deleteHousehold_removesHouseholdAndRelatedData() =
        runTest {
    ...
    @Test
    fun createInviteCode_successfullyCreatesCode() =
        runTest {
    ...
    @Test
    fun validateInviteCode_returnsValidCode() =
        runTest {
    ...
    @Test
    fun validateInviteCode_returnsNullForInvalidCode() =
        runTest {
    ...
    @Test
    fun redeemInviteCode_successfullyAddsUserToHousehold() =
        runTest {
    ...
    @Test
    fun getInviteCodesForHousehold_returnsAllCodes() =
        runTest {
    ...
    @Test
    fun revokeInviteCode_removesCode() =
        runTest {
    ...
    @Test
    fun isUserMemberOfHousehold_returnsTrueForMember() =
        runTest {
    ...
    @Test
    fun isUserMemberOfHousehold_returnsFalseForNonMember() =
        runTest {
    ...
    @Test
    fun leaveHousehold_removesUserFromMembers() =
        runTest {
            // Create household
            ...
            val updatedHousehold = repository.getHouseholdById(household.id)
            assertFalse(
                "User should not be in members after leaving",
    ...
    @Test
    fun addShoppingListItem_successfullyAddsItem() =
        runTest {
    ...
    @Test
    fun removeShoppingListItem_successfullyRemovesItem() =
        runTest {
    ...
    @Test
    fun getShoppingListItems_returnsAllItems() =
        runTest {
