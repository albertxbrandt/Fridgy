...
class CategoryViewModelTest {
    ...
    @Test
    fun `loading categories updates state to Success`() =
        runTest {
            val testCategories =
                listOf(
    ...
    @Test
    fun `loading categories failure updates state to Error`() =
        runTest {
    ...
    @Test
    fun `createCategory calls repository`() =
        runTest {
            coEvery { mockRepository.getCategories() } returns flowOf(emptyList())
    ...
    @Test
    fun `updateCategory calls repository`() =
        runTest {
            coEvery { mockRepository.getCategories() } returns flowOf(emptyList())
    ...
    @Test
    fun `deleteCategory calls repository`() =
        runTest {
            coEvery { mockRepository.getCategories() } returns flowOf(emptyList())
